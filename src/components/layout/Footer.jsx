const Footer = () =>{
    ...
    <div className="container-fluid bg-dark text-white py-4">
        <div className="container text-center">
            <p className="mb-0">&copy; <a className="text-secondary fw-bold" href="/">Your Site Name</a>. All Rights Reserved. Designed by <a className="text-secondary fw-bold" href="/">Team Two</a></p>
        </div>
    </div>
        </>
    )
